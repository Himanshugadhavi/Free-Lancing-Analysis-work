library(readxl)
pca <- read_excel("E:/7. Free lancing analysis/GCV and PCV analysis Project/modified data analysis/clustering and mahalnobis distance/modified_data.xlsx", 
                            sheet = "Sheet2")
pca
# scaling the data #
scd <- scale(pca[,-1])
...
setwd("E:/7. Free lancing analysis/GCV and PCV analysis Project/modified data analysis")
getwd()
